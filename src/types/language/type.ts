...
export interface Language {
    "replies": {
        ...
        "status": {
            "title": string | "Bot Status & Statistics",
            "refresh": string | "Refresh",
            "invite": string | "Invite me",
            "vote": string | "Vote for me",
            "guilds": string | "Total Servers:",
            "users": string | "Total Users:",
            "voice": string | "Voice Connections:",
            "commands": string | "Total Commands:",
            "ping": string | "System Latency:",
            "uptime": string | "Uptime Status:",
            "memory": string | "Memory Usage:",
            "cpu": string | "CPU Load:",
            "version": string | "Software Version:",
            "totalCommands": string | "Total Commands Used:",
            "guildUnit": string | "Servers:",
            "userUnit": string | "Users:",
            "channelUnit": string | "Channels:",
            "refreshedBy": string | " | Last refreshed by {user}"
        },
